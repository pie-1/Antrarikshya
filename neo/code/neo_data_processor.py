...
# Compute and update derived values (Aphelion and Perihelion distances)
...
#class definition and returns the type of NEOs around the earth
...
if __name__=="__main__":
    ...
    # Create a new column 'NEOClass' by applying the function row-wise
